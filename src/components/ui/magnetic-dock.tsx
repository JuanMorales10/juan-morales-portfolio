...
/**
 * Magnetic Dock, de Componentry (https://componentry.dev/r/magnetic-dock.json).
 * Adaptado: `framer-motion` pasa a `motion/react`, que ya trae el proyecto, así
 * no se suma una dependencia.
 */
